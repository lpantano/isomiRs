...
frontal cortex samples (Somel et al, 2010) to give some basic examples of isomiRs analyses.
...
The function \Rfunction{loadFromFiles} needs a vector with the paths for each file
